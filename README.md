...
- Student data input validation (Name and Student ID/NIM)
- Multi-course selection handling via arrays
- Automated invoice and discount calculation (If/Else logic)
- Course list rendering using loops
